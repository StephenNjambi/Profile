...
const Projects = () => {
  ...
  return (
    <>
      <section
        id="projects"
        className={`w-6/7 rounded-lg mx-auto my-8 dark:bg-gray-900 transition-transform duration-500 ease-in-out transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
      >
                <div className="container px-6 py-10 mx-auto">
                <h1 className="text-3xl font-semibold text-white-800 capitalize lg:text-4xl dark:text-white">
                    My <span className="underline decoration-blue-500">Projects</span>
                </h1>
                <p className="mt-4 text-white-500 xl:mt-6 dark:text-gray-300">
                    Welcome to my portfolio! Here you'll find a showcase of my recent projects
                </p>
