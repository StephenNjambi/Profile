...
const Projects = () => {
  ...
  return (
    <>
      <section
        id="projects"
        className={`w-6/7 rounded-lg mx-auto my-16 dark:bg-gray-900 transition-transform duration-500 ease-in-out transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}
      >
                <div className="container px-6 py-10 mx-auto">
                <h1 className="text-3xl font-semibold text-white-800 capitalize lg:text-4xl dark:text-white">
                    My <span className="decoration-blue-500">Projects</span>
                </h1>
                <p className="mt-4 text-white-500 xl:mt-6 dark:text-gray-300">
                    Find a showcase of my recent projects
                </p>
                ...
                <ProjectCard
                    ...
                    title="Mysupport "
                    description="Mysupport is an open-source service management suite that includes help desk ticketing, IT service management (ITSM), and customer service software. It is widely used by businesses and organizations to streamline their support processes, manage customer inquiries, and handle service requests efficiently."
                />
            ...
            {/* Repeat the above ProjectCard components here */}
          </div>
        </div>
      </section>
...
const ProjectCard = ({ icon, title, description }) => {
  return (
    <div className="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
      ...
      <a href="https://mysupport.atlancis.com/otrs/index.pl" className="inline-flex p-2 text-blue-500 capitalize transition-colors duration-200 transform bg-blue-100 rounded-full dark:bg-blue-500 dark:text-white hover:underline hover:text-blue-600 dark:hover:text-blue-500">
        see more
      </a>
